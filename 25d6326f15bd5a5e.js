(globalThis["webpackChunk_canva_web"] = globalThis["webpackChunk_canva_web"] || []).push([[70386], {
    ...
    649000: function(_, __, __webpack_require__) {
        ...
        (function(__c) {
            ...
            var KGc = function(a, b) {
              ...
              , LGc = function(a) {
                return b => {
                    for (const e of a) {
                        ...
                        c = typeof c === "boolean" ? c ? As() : Bs() : c.state === "invalid" && c.error == null ? Bs() : c;
                        if (c.state === "invalid")
                            return c
                    }
                    return As()
              ...
              , MGc = function(a, b) {
                ...
                case 2:
                    return a;
                case 3:
                    return b.error ? c3(b.error(a.error)) : a;
                default:
                    throw new A(a);
                }
            }
              ...
              , OGc = async function(a, b) {
                try {
                    const {hW: c} = await (a.BRb ?? (a.BRb = __webpack_require__.me(434895).then( () => __c.QGc)))
                      , d = JSON.parse(c);
              ...
              , k7 = function(a, b, c) {
                if (b)
                    ...
                    case "unknown_option_id":
                        return a.bBa();
                    case "invalid_format":
                        return c.type === 5 ? a.QAa() : a.PAa();
                    case "invalid_email":
                        return a.OAa();
                    case "out_of_bounds":
                        switch (c?.type) {
                        case 4:
                            return b.params.exact != null ? a.ZAa(b.params.exact) : b.params.FX != null ? a.aBa(b.params.FX) : a.$Aa(b.params.Nva);
                        case 1:
                        case 2:
                        case 3:
                            return b.params.exact != null ? a.WAa(b.params.exact) : b.params.FX != null ? a.YAa(b.params.FX) : a.XAa(b.params.Nva);
                        case 5:
                            return b.params.exact != null ? a.SAa(b.params.exact) : b.params.FX != null ? a.UAa(b.params.FX) : a.TAa(b.params.Nva);
                        default:
                            throw new A(c);
                        }
                    default:
              ...
              , TGc = function(a) {
                a = {
                    ...__c.kk,
                    stream: Ug.Mb().attrs(a.stream.Xg(0)).nb(a.stream.Z.trim() + "*\n").build()
                };
                return jk.create(a)
            }
              , ZGc = function(a) {
              ...
              , $Gc = function(a) {
                const b = a.color;
                a = a.$a;
                return b ? b : a.ref ? a.ref.uh[0].color : "#ffffff"
            }
              , n7 = function(a, b) {
              ...
              , aHc = function(a, b, c) {
                ...
                u(!0);
                u(!0);
                const {ta: d, a: e, b: f} = __c.ql(a)
                  , {ta: g, a: h, b: k} = __c.ql(b)
                  , l = (d + g) / 2;
                ...
                const b = a.Aub
                  ...
                  , [g,h,k] = p7( () => {
                    ...
                    case 1:
                        return [c.Qm, d.Qm];
                    case 0:
                        return e ? [c.selected, d.selected] : f === j7 || f === i7 ? [c.Qm, d.Qm] : [c.default];
                    default:
                        throw new A(b);
                    }
                }
                , [b, c.Qm, c.selected, c.default, d.Qm, d.selected, e, f])
                  , l = b === 0 || b === 1;
                return f7(eHc, {
                    ...a,
                    eb: k,
                    D_: a.hqa === "s" ? void 0 : e ? d.selected : d.default,
                    HEa: h,
                    backgroundColor: {
                        default: g,
                        Ig: l ? c.Ig : g,
              ...
              , eHc = function(a) {
                ...
                l = p7( () => {
                    const Q = g.stream.un(0);
                    return n !== void 0 ? r7(`${n.value}%`, {
                        ...Q,
                        "font-weight": "bold",
                        color: n.hd,
                        "font-size": Tf(lg, Q, "font-size") * gHc
                    }) : void 0
                }
                , [n, g]);
                const S = m === h7;
                return s7("div", {
                    className: g7("VTAQRg", !(f || n) && "zt5zlQ", S && "A_ugOA", (m === i7 || m === j7) && "zMViSA", f && "Buj71Q"),
                    style: {
                        "--_v6jRQ": c.default,
                        "--CGAV4g": c.selected,
                        "--6wmixw": c.Ig,
                    ...
                    onClick: S ? Q => {
                        N.current?.contains(Q.target) || J.current?.contains(Q.target) || J.current?.click()
                    }
                    : void 0,
                    children: [f7("input", {
                        "aria-invalid": !!t,
              ...
              , nHc = function(a, b, c, d) {
                const e = f => {
                    const g = c();
                    return g != null ? `${f} | ${b.xGa(g)}` : f
                }
                ;
                switch (a) {
                case 0:
                    return e(d ? b.cGa() : b.tPa());
                case 1:
                case 5:
                    return e(d ? b.bGa() : b.uPa());
                case 2:
                    return b.offline();
                case 3:
                    return b.loading();
              ...
              , tHc = function(a, b) {
                ...
                case 0:
                    ...
                    a = rHc(b, a.cKa);
                    return {
                        kZ: c.map( ({label: d}) => d).join(", "),
                        vT: a.map( ({id: d}) => d)
                    };
                case 2:
                case 1:
                    return c = sHc(b, a.value),
                    {
                        kZ: a.value,
                        vT: c ? [c.id] : []
                    };
              ...
              , uHc = function(a) {
                switch (a.type) {
                case 0:
                    return a = rHc(a.options, a.cKa).map( ({label: b}) => b).join(", "),
                    {
                        kZ: a,
                        vT: a
                    };
              ...
              , CHc = function(a) {
                ...
                const b = a.form.fields.first().id ?? ""
                  , c = v7(a, b, "select");
                a = a.qBa.get(b);
                return a?.$L == null ? 0 : qHc(c.zG, a.$L) ? 2 : 1
            }
              , v7 = function(a, b, c) {
                let d = a.kZa.get(b);
                ...
                d && d.Ad === e || (c = w7( () => a.NBa.get()?.getContext(a.form.id)?.l2b?.get(b) ?? a.qBa.get(b)),
                d = BHc(e, a.context, c),
                a.kZa.set(b, d));
                return d
            }
                ...
                return {
                    ...
                    ...function() {
                        ...
                        return c ? {
                            ...
                            uH: c,
                            $fa: c,
                            rTa: yl(__c.Fl(__c.Bl(__c.vl(c), .8), __c.vl(b)))
                        } : {
                            Eyb: d?.Ua === 1 ? n7(b, o7) : n7(a, o7),
                            F4: n,
                            amb: e ? n7(a, o7) : a,
                            uH: n7(b, o7),
                            $fa: n7(b, JHc),
              ...
              , NHc = function(a) {
                return new MHc(a.data.D.value,a.Fr)
            }
              , OHc = function(a, b) {
                const c = y7(b);
                b = a.oT.get(c);
              ...
              , QHc = function(a) {
                return z7( () => {
                    const b = a.formData.iG
                      , c = a.Fr.getSettings(b);
                    return [a.formData.ss, b, c]
                }
                , async ([b,c,d]) => {
                    if (d.status === 1) {
                        var e = y7({
                            ss: b,
                            submitter: d.data.vMa
                        });
                        d = a.oT.get(e);
                        if (d !== "initialized" && d !== "initializing") {
                            a.oT.set(e, "initializing");
                            var f = await a.sI.s2b({
                                ss: b,
                                iG: c
                            });
                            x7( () => {
                                a.oT.get(e) !== "initialized" && (a.oT.set(e, "initialized"),
                                f.ok && f.value && a.Jca.set(e, f.value))
                            }
                            )
                        }
                    }
                ...
                , {
                    equals: PHc.structural
                })
            }
              , y7 = function(a) {
                return [a.ss, JSON.stringify(a.submitter)].join(":")
            }
              , UHc = function(a) {
                const b = a.title
                  , c = a.id
                  ...
                  , l = a.W
                  , m = a.J2b
                  , [n,p] = [f, g].map(q => typeof q === "string" ? q : q.uh[0].color || "#ffffff");
                return {
                    minHeight: 500,
                    minWidth: 368,
                    id: c,
                    ...
                    z_: !1,
                    ara: !1,
                    fields: d.map(q => SHc(q, p, e)).slice(0, wc("5684dca7", 10)),
                    BS: {
                        Cq: 1.953,
                        Bq: 1.953,
                        Gt: .64
                    ...
                    footer: {
                        label: {
                            type: "text2",
                            text: A7(m.slice(0, wc("f368b7e8", 250)), {
                                "text-align": "center",
                                "font-weight": "bold",
                                color: n === p ? p : n7(n, o7),
                                "font-size": THc,
              ...
              , SHc = function(a, b, c) {
                const d = {
                    label: {
                        type: "text2",
                        text: A7(a.label.slice(0, wc("f368b7e8", 250)), VHc(b, c))
                    },
                    IEa: 1,
                    required: a.required,
                    id: __c.sq(),
                ...
                case "select":
                    const e = []
                      , f = a.options.map( (g, h) => {
                        ...
                        a.variant.type === 2 && a.variant.BYb.includes(h) && k.id && e.push(k.id);
                        return k
                    }
                    );
                    return {
                        ...
                        type: "select",
                        A0: a.E$b ? 0 : 1,
                        variant: WHc(a.variant),
                        kya: e,
                        options: f.slice(0, wc("55264882", 10))
                    };
                case "text":
                    return {
                        ...d,
            ...
            __c.cA.prototype.eIa = __c.fa(19, function() {
                return __c.Yz(this, () => __c.Kz(this.operators, "%", this.value))
            });
            var B7 = __webpack_require__(186901)
              ...
              , DHc = B7.tC
              , e7 = B7.XI;
            var bIc = __webpack_require__(322594)
              , f7 = bIc.jsx
              , s7 = bIc.jsxs;
            var cIc = __webpack_require__
              , dIc = cIc(208463)
              , g7 = cIc.n_x(dIc)();
            var D7 = __webpack_require__(205482)
              , UGc = D7.Children
              , eIc = D7.createElement
              , fIc = D7.useEffect
              , q7 = D7.useId
            ...
            var gIc = __webpack_require__(536618).iB;
            var hIc = a => sb("JWYKDQ", [a])
              , iIc = () => K("jh7u2w")
              , jIc = a => sb("Jj1O+A", [a])
              , kIc = a => sb("sUWUOA", [a])
              , lIc = a => sb("Q5Pg4w", [a])
            ...
            var F7 = 0
              ...
              , JIc = class {
                ...
                getText(a, b, c) {
                    a = this.hW?.[a];
                    c?.length ? a ? (b = this.document.language,
                    c = (new __c.tb(a,b ? __c.Jaa(b) : void 0,__c.Kaa,{
                        ignoreTag: !0
                    })).format(Object.fromEntries(Object.entries(c)))) : c = b(...c) : c = a || b();
                    return c
                }
                XAa(...a) {
                    return this.getText(G7.XAa, DIc, a)
                }
                RAa() {
                    return this.getText(G7.RAa, nIc)
                }
                jya() {
                    return this.getText(G7.jya, FIc)
                }
                pDa() {
                    return this.getText(G7.pDa, qIc)
                }
                AJa() {
                    return this.getText(G7.AJa, rIc)
                }
                xGa(...a) {
                    return this.getText(G7.xGa, xIc, a)
                }
                V$a(...a) {
                    return this.getText(G7.V$a, kIc, a)
                }
                offline() {
                    return this.getText(G7.offline, zIc)
                }
                loading() {
                    return this.getText(G7.loading, wIc)
                }
                wMa() {
                    return this.getText(G7.wMa, sIc)
                }
                uPa() {
                    return this.getText(G7.uPa, HIc)
                }
                tPa() {
                    return this.getText(G7.tPa, oIc)
                }
                bGa() {
                    return this.getText(G7.bGa, IIc)
                }
                cGa() {
                    return this.getText(G7.cGa, pIc)
                }
                gIa() {
                    return this.getText(G7.gIa, CIc)
                }
                VAa() {
                    return this.getText(G7.VAa, AIc)
                }
                bBa() {
                    return this.getText(G7.bBa, GIc)
                }
                QAa() {
                    return this.getText(G7.QAa, EIc)
                }
                PAa() {
                    return this.getText(G7.PAa, iIc)
                }
                ZAa(...a) {
                    return this.getText(G7.ZAa, tIc, a)
                }
                aBa(...a) {
                    return this.getText(G7.aBa, lIc, a)
                }
                $Aa(...a) {
                    return this.getText(G7.$Aa, yIc, a)
                }
                SAa(...a) {
                    return this.getText(G7.SAa, vIc, a)
                }
                UAa(...a) {
                    return this.getText(G7.UAa, hIc, a)
                }
                TAa(...a) {
                    return this.getText(G7.TAa, mIc, a)
                }
                WAa(...a) {
                    return this.getText(G7.WAa, jIc, a)
                }
                YAa(...a) {
                    return this.getText(G7.YAa, BIc, a)
                }
                OAa() {
                    return this.getText(G7.OAa, uIc)
                }
                constructor(a) {
                    this.document = a;
                    this.hW = (JIc.G(this),
                    void 0);
                    z7( () => a.language, () => PGc(this), {
                        fireImmediately: !0
                    })
                }
            }
            ;
            var KIc = class extends JIc {
            }
            ;
            var LIc = q0.fi({
                type: q0.dj(46, "text2"),
                text: q0.Gm(2423, "Richtext2")
            })
              , MIc = q0.s3({
                type: void 0
            }, LIc)
              ...
              , TIc = q0.fi({
                ...NIc,
                type: q0.dj(46, "select"),
                variant: q0.F7a(48, SIc),
                options: q0.listRef(41, OIc),
                A0: q0.tHb(39, {
                    min: 0
                }),
                kya: q0.DSa(1549, q0.qMa())
            })
              , UIc = q0.fi({
                type: q0.dj(46, "e")
            })
              ...
              , XIc = q0.fi({
                ...NIc,
                type: q0.dj(46, "text"),
                variant: q0.ref(48, WIc),
                placeholder: q0.Az(42)
            })
              , YIc = q0.fi({
                type: q0.dj(46, "a")
            })
              ...
              , cJc = q0.fi({
                ...NIc,
                type: q0.dj(46, "number"),
                variant: q0.ref(48, bJc),
                min: q0.Hj(1),
                max: q0.Hj(2)
            })
              , dJc = q0.s3({
              ...
              , gJc = q0.fi({
                ...
                Cq: q0.Hj(3),
                Bq: q0.Hj(4),
                background: q0.D7a(5, "Fill")
            })
              , hJc = q0.fi({
                Fi: q0.Hj(4),
                xj: q0.Hj(5),
                minHeight: q0.Hj(2062),
                minWidth: q0.Hj(2077),
                type: q0.dj(46, "poll", "quiz"),
                id: q0.Lx(35),
                ss: q0.Lx(45),
                iG: q0.Az(27),
                direction: q0.gC(44, "l", "r"),
                Tha: q0.Az(30),
                gba: q0.Gm(2216, "Fill"),
                Rba: q0.Gm(2372, "Fill"),
                border: q0.Gm(28, "Stroke"),
                W: q0.Hj(29),
                z_: q0.zaa(1802),
                cDa: q0.zaa(9),
                ara: q0.zaa(52),
                HWa: q0.F7a(34, q0.fi({})),
                title: q0.ooa(36, {
                    label: q0.Gm(1, "Richtext2"),
                    aJ: q0.vma(2430, "c", "u")
                }),
                header: q0.ooa(1, gJc.fields),
                fields: q0.listRef(32, dJc),
                BS: q0.ooa(6, eJc.fields),
                footer: q0.ooa(1705, fJc.fields)
            })
              , iJc = __c.a_({
                type: q0.dj(37, "poll", "quiz"),
                value: q0.ref(48, hJc)
            });
            var A7 = (a, b) => ({
                ...__c.kk,
            ...
            var H7 = E7(a => {
                const {Ad: b, Ae: c, Zo: d, errorMessage: e, xM: f, D8: g=!0} = a
                  , h = c.Tj
                  , k = b.label.stream.Ro("font-family")["font-family"];
                var l = b.label.stream.Ro("direction").direction;
                ...
                return s7(m, {
                    ...
                    dir: l,
                    children: [b.rdb && f7(n, {
                        htmlFor: g ? void 0 : a.K7,
                        "data-testid": t7.label,
                        style: {
                            paddingBlockEnd: `${b.padding.UBb}px`
                        },
                        children: f7(h, {
                ...
                return f7(H7, {
                    ...
                    children: f7(ZGc, {
                        ...
                        children: a.map( ({jLb: n}) => {
                            ...
                            p = p === n;
                            return s7("div", {
                                className: g7("dAwWRA", f === h7 && !p && "oKt_Cg", (f === i7 || f === j7) && "HLJxlw", p && "kpt6Eg"),
                                style: {
                                    borderRadius: b.W,
                                    padding: `${b.padding.Qa}px`,
                                    "--dayejg": b.backgroundColor.default,
                                    "--1PG0Mg": b.backgroundColor.Ig,
                                    "--9P_0YQ": b.backgroundColor.active,
                                    "--1y49lg": b.backgroundColor.selected,
                                    "---3Rdqg": b.backgroundColor.Qm,
                                ...
                                children: [f7("input", {
                                    ...
                                    children: f7(c.Tj, {
                                        text: r7(String(n), {
                                            "font-family": Tf(lg, b.label.stream.Xg(0), "font-family"),
                                            color: p ? b.hd.selected : b.hd.default,
                                            "text-align": "center",
                                            "font-size": b.sizes.b6
                                        })
                                    })
                                })]
                            }, n)
              ...
              , nJc = E7(a => {
                ...
                return f7(H7, {
                    ...
                    children: f7(ZGc, {
                        CEa: b.sizes.Nwa,
                        gridGap: b.gridGap,
                        children: a.map( ({R$: m, eb: n, label: p}) => {
                            const q = Number(g)
                              , r = g === String(m)
                              , t = `${l}-${m}`
                            ...
                            return s7("div", {
                                ...
                                children: [f7("input", {
                                    ...
                                    children: f7(n, {
                                        size: b.sizes.Qc,
                                        color: r ? b.D_.selected : b.D_.default
                                    })
                                })]
                            }, m)
                        }
            ...
            var oJc = E7(a => {
                ...
                const g = c.Iea
                  ...
                  , l = p7( () => h ? {
                    ...
                    default: b.borderColor.default,
                    Ig: b.borderColor.default,
                    focus: b.borderColor.default
                }, [b.borderColor.default, b.borderColor.error, b.borderColor.focus, b.borderColor.Ig, e, h])
                  , m = b.label.stream.Xg(0)
                  , n = jJc[Tf(lg, m, "font-weight")];
                f = k7(f, d.PK, b);
                const p = q7();
                return f7(H7, {
                    Ad: b,
                    ...
                    children: s7("div", {
                        ...
                        children: [f7(g, {
                            ...
                            type: "text",
                            inputMode: "numeric",
                            FBa: Tf(lg, m, "font-family"),
                            fontSize: `${b.sizes.b6}px`,
                            bj: b.hd,
                            fontWeight: n,
                            value: a ?? "",
                            name: b.id,
                ...
                return f7(H7, {
                    ...
                    children: f7("div", {
                        ...
                        children: g.map(t => {
                            ...
                            case 1:
                                var z = p.get();
                                z = z ? Math.round(100 * (z.rbc.get(t.id) ?? 0) / (z.total || 1)) : void 0;
                                return eIc(eHc, {
                                    ...x,
                                    key: t.id,
                                    backgroundColor: {
                                        default: z != null ? b.eOa.track : b.Bz.default,
                                        Ig: b.Bz.Ig,
                                        active: b.Bz.active,
                                        selected: z != null ? b.cPa.track : b.Bz.selected
                                    },
                                    HEa: v ? b.hC.selected : r ? void 0 : b.hC.Qm,
                                    D_: v ? b.hC.selected : b.hC.default,
                                    eIa: z != null ? {
                                        value: z,
                                        rnb: v ? b.cPa.zL : b.eOa.zL,
                                        hd: v ? b.cPa.text : b.eOa.text
                                    } : void 0,
                                    onChange: e7( () => {
                                        d.YMa(t.id);
                                        d.$y = !0;
                            ...
                            case 2:
                                return v = n.get(),
                                v = v == null ? 0 : v.includes(t.id) ? x.ai ? 4 : 2 : x.ai ? 3 : 1,
                                eIc(fHc, {
                                    ...x,
                                    key: t.id,
                                    Bz: b.Bz,
                            ...
                            case 3:
                                return eIc(eHc, {
                                    ...
                                    HEa: v ? b.hC.selected : r ? void 0 : b.hC.Qm,
                                    backgroundColor: {
                                        default: b.Bz.default,
                                        selected: b.Bz.selected,
                                        Ig: b.Bz.Ig,
                                        active: b.Bz.active
                                    }
                                });
                        ...
                        children: Array.from({
                            ...
                            return s7("label", {
                                ...
                                children: [f7("input", {
                                    ...
                                    size: b.Qc,
                                    color: q ? r === "hover" ? b.fillColor.Ig : b.fillColor.selected : b.fillColor.Qm
                                }) : f7(kHc, {
                                    size: b.Qc,
                                    color: q ? b.borderColor.default : b.borderColor.Qm
                                })]
                            }, v)
                        }
                        )
            ...
            var sJc = E7(a => {
                ...
                var n = p7( () => k ? {
                    ...
                    Ig: b.borderColor.default,
                    focus: b.borderColor.default
                }, [b.borderColor.default, b.borderColor.error, b.borderColor.focus, b.borderColor.Ig, m, k]);
                const p = b.label.stream.Xg(0)
                  , q = jJc[Tf(lg, p, "font-weight")]
                  , r = q7();
                n = {
                    boxSizing: "border-box",
                    FBa: Tf(lg, p, "font-family"),
                    fontSize: `${b.sizes.b6}px`,
                    bj: m ? b.hd.default : b.hd.Qm,
                    fontWeight: q,
                    padding: b.padding.Qa,
                    paddingInlineEnd: k ? b.sizes.Qc * 1.5 : void 0,
                    d9a: b.placeholder.color,
                    width: "100%",
                    qwa: n,
                    backgroundColor: "transparent",
                    borderStyle: "solid",
                ...
                return f7(H7, {
                    ...
                    children: s7("div", {
                        ...
                        children: [b.TN > 1 ? f7(h, {
                            ...
                            className: g7("Xz8a5Q", b.TN > 1 && "XsCoFw"),
                            style: {
                                "--ozZJmw": `${b.sizes.Qc * .4}px`
                            },
                            children: f7(bHc, {
                                size: b.sizes.Qc
                            })
            ...
            var tJc = E7(a => {
                ...
                u(!0);
                const g = f + __c.xB(__c.wB(new __c.rQa("/form-data-processing"), "formUrl", window.location.href));
                return s7("footer", {
                    children: [f7("div", {
                    ...
                    }), a.footer.zyb && a.XH !== 2 && f7("div", {
                        className: "_4x6reg",
                        children: f7("a", {
                            onClick: h => {
                                a.ph && (a.ph.rna(new __c.Zy({
                                    uri: g,
                                    target: 1
                                })),
                                h.preventDefault())
            ...
            var uJc = E7(a => {
                ...
                return s7("div", {
                    ...
                    style: {
                        ...
                        paddingBlockEnd: `${b.padding.Aa}px`
                    },
                    id: a.Cyb,
            ...
            var h7 = 0
              ...
              , vJc = E7(function(a) {
                ...
                const [t] = l7( () => new KIc({
                  ...
                  , x = u7(d, "p")
                  , z = d.XH === 6 || d.XH === 7 && !x ? 2 : d.XH === 5 ? 1 : d.ZRa ? 0 : 3
                  , B = d.$o ? null : oHc(CHc(d), b.footer, f, t, v)
                  , C = !!k && (d.$o || !B)
                  , D = q7();
                return s7("div", {
                    "aria-labelledby": D,
                    ...
                    children: [f7("div", {
                        ...
                        children: [g && f7(uJc, {
                            ...
                            style: {
                                rowGap: b.L7.rowGap,
                                paddingBlockStart: `${b.L7.ja}px`,
                                paddingInlineStart: `${b.L7.ma}px`,
                                paddingBlockEnd: `${b.L7.Aa}px`,
                                paddingInlineEnd: `${b.L7.Ma}px`
                            },
                            children: h.map(E => f7("div", {
                                className: g7("_6i3kwQ", "wNH5Fw", !!(E.type === 4 || E.type === 5 && E.variant === 3 || E.type === 5 && E.variant === 1) && "Od1Udw"),
                                children: ( () => {
                                    switch (E.type) {
                                    case 4:
                                        return f7(sJc, {
                            ...
                            className: g7("WwpS_Q"),
                            style: {
                                paddingInlineStart: `${b.a_.ma}px`,
                                paddingInlineEnd: `${b.a_.Ma}px`,
                                paddingBlockEnd: `${b.a_.Aa}px`
                            },
                            children: [C && f7(RGc, {
                                label: v(k.label),
                                mga: k.backgroundColor,
                                Mr: z,
                                onClick: e7( () => d.submit()),
                                padding: k.padding
                            }), B && f7("div", {
                                style: {
                                    paddingBlockStart: `${b.a_.FJb}px`,
                                    paddingBlockEnd: `${b.a_.EJb}px`
                                },
                                children: B
                            }), f7("div", {
                                style: {
                                    paddingBlockStart: `${b.a_.qEb}px`
                                },
                                children: f7(tJc, {
                                    footer: b.footer,
                                    XH: d.XH,
                                    messages: t,
                                    lxb: () => {
                                        var E = u7(d, "p") ? d.n0.get()?.fields.get(d.form.fields.first().id ?? "")?.total ?? 0 : void 0;
                                        return E
                                    }
                                    ,
                                    kwb: f,
            ...
            var wJc = {
                ...
                wf(a) {
                    return __c.Rq({
                        ...
                        action: a.action,
                        location: a.location,
                        linked_design_id: a.i5b,
                        toggle_value: a.BK,
                        editing_context: a.zd == null ? void 0 : __c.Sq(a.zd),
                        performance_context: a.Yd == null ? void 0 : __c.Tq(a.Yd),
                        question_type: a.Dcc
                    })
                }
            };
            var J7 = class {
                ...
                get E3() {}
                get zG() {
                    return this.context.mode === "edit" ? this.empty : this.Gu
                }
                get D3() {
                    if (this.isEmpty())
                        return this.required ? Ea({
                            uE: "required"
                        }) : (0,
                        __c.Aa)();
                    const a = this.OJa(this.zG);
                    if (a.ok) {
                        const b = this.YRa(a.value);
                        if (b.state === "invalid")
                            return Ea(b.error)
                    }
                    return a
                ...
                get YRa() {
                    ...
                    return a?.length ? LGc(a) : As
                }
                get Pbb() {
                    return this.D3.map( () => this.isEmpty() ? void 0 : this.Ba(this.zG))
                }
                get PK() {
                    return this.$y && !this.D3.ok && this.context.mode === "interact" ? this.D3.error : void 0
                }
                get required() {
                    return !!this.Ad.required
                }
                isEmpty() {
                    const a = this.zG;
                    return a.length === 0 ? !0 : typeof a === "string" ? (a != null && a.trim().length > 0 ? As() : Bs()).state === "invalid" : !1
                }
                constructor(a, b, c) {
                    this.Ad = a;
                    this.context = b;
                    ...
                    this.$y = (J7.G(this),
                    !1);
                    z7( () => NGc(this.context.nma), d => {
                        d && (this.Gu = (d = d.Bmb.get(this.Ad.id ?? "")) ? this.ra(d) : this.empty,
                        this.$y = !1)
                    }
                    )
                }
            ...
            var xJc = /^\s*-?(?:\d+[, ])*(?:\d*\.)?\d*\s*$/
              ...
              , AHc = class extends J7 {
                ...
                OJa(a) {
                    return xJc.test(a) && (a = a.replace(yJc, ""),
                    a = Number(a),
                ...
                Ba(a) {
                    return {
                        type: 2,
                        K7: this.Ad.id ?? "",
                        rn: this.Ad.label.text.stream.Z,
                        value: a
                    }
                }
                ra(a) {
            ...
            var yHc = class extends J7 {
                ...
                get H7a() {
                    return new Set(this.Ad.options.map( ({id: a}) => a ?? ""))
                }
                get E3() {
                    return [wHc({
                        max: xHc(this.Ad.A0)
                ...
                OJa(a) {
                    return a.every(b => this.H7a.has(b)) ? (0,
                    __c.Aa)(a.slice()) : Ea({
                        uE: "unknown_option_id"
                    })
                }
                Ba(a) {
                    return {
                ...
                ra(a) {
                    return tHc(a, this.AHa).vT
                }
                get AHa() {
                    return this.Ad.options.map(a => ({
                        id: a.id ?? "",
                ...
                constructor(...a) {
                    super(...a);
                    this.type = (yHc.G(this),
                    "select");
                    this.empty = [];
                    this.Gu = [];
                    this.YMa = b => {
                        const c = this.zG;
                        this.Gu = c?.includes(b) ? c.filter(d => d !== b) : xHc(this.Ad.A0) > 1 && c?.length ? [...c, b] : [b]
                    }
                }
            }
            ;
            var zHc = class extends J7 {
                ...
                get E3() {
                    const a = wc("b9892c2d", 500);
                    return [a != null ? wHc({
                        min: 0,
                        max: a
                    }) : void 0, this.Ad.variant.type === "e" ? KGc(__c.NLb, {
                        uE: "invalid_email"
                    }) : void 0]
                }
                OJa(a) {
            ...
            var zJc = class {
                ...
                get nma() {
                    ...
                    const a = this.Fr.getSettings(this.formData.iG);
                    switch (a.status) {
                    case 2:
                    case 3:
                        return a;
                ...
                get mode() {
                    return this.NBa.get()?.getContext(this.formData.id) ? "edit" : "interact"
                }
                constructor(a, b, c, d) {
                    this.formData = a;
                    this.Fr = b;
            ...
            var GHc = Symbol()
              , AJc = class {
                ...
                get $L() {
                    const a = this.Fr?.getSettings(this.form.iG);
                    return a?.status === 1 ? a.data.$L : void 0
                }
                get qBa() {
                    var a = NGc(this.context.nma);
                    if (a) {
                        {
                            var b = this.tN;
                            a = a != null ? this.n0.get() : void 0;
                            var c = this.$L;
                ...
                get mP() {
                    return this.HT ? 2 : d7(this.context.nma, {
                        MO: a => a == null ? 1 : 3,
                        loading: () => 4,
                        error: () => 1
                    })
                ...
                get XH() {
                    return this.cb?.status === 2 ? 2 : this.sI && this.Fr && this.GM ? this.mP === 2 ? 6 : this.mP === 3 ? 7 : this.mP === 4 ? 3 : d7(this.context.NY, {
                        MO: ({submitter: a}) => a?.type === "USER" ? 0 : 1,
                        loading: () => 3,
                        error: () => 4
                    }) : 5
                }
                get ZRa() {
                    if (!this.sI || this.context.mode !== "interact")
                        return !1;
                    switch (this.XH) {
                    case 1:
                    case 0:
                ...
                constructor(a, b, c, d, e, f, g, h) {
                    ...
                    this.HT = !1;
                    this.n0 = C7.box();
                    this.submit = $Hc(function*() {
                        const k = this.sI
                          , l = this.GM;
                        var m = this.context;
                        const n = this.la;
                        var p = this.form.fields;
                        const q = this.form.iG
                          , r = this.form.ss
                          , t = this.form.id
                          , v = this.form.type;
                        var x = (this.mP === 1 || u7(this, "p") && this.mP === 3) && this.context.mode === "interact";
                        if (k && x && l && m.NY.status === 1) {
                            x = !0;
                            m = m.NY.data;
                            var z = [];
                            for (const C of p)
                                ...
                                p.$y = !0,
                                p = p.Pbb,
                                p.ok ? x && p.value != null && z.push(p.value) : x = !1;
                            if (x)
                                if (z.length === 0)
                                    this.tN = Ea({
                                        uE: 5,
                            ...
                            this.tN.ok || HHc(this, this.tN.error)
                        }
                    });
                    this.sba = $Hc(function*() {
                        const k = this.sI
                          , l = this.GM
                          , m = this.context
                          , n = this.form.ss
                          , p = (this.mP === 1 || u7(this, "p") && this.mP === 3) && this.context.mode === "interact";
                        if (k && p && l && m.NY.status === 1) {
                            this.HT = !0;
                            try {
                                (yield k.sba({
                                    ss: n
                                })).ok ? (this.la?.track(wJc, {
                                    b_: this.form.id,
                                    PBa: "poll",
                                    lu: "interacted",
                    ...
                    this.PCa = $Hc(function*(k) {
                        v7(this, k, "select").isEmpty() ? (this.la?.track(wJc, {
                            b_: this.form.id,
                            PBa: "poll",
                            lu: "interacted",
                            action: "response_unsubmitted",
                        ...
                        yield this.sba()) : yield this.submit()
                    });
                    z7( () => a.ss, () => {
                        this.tN = void 0;
                        this.n0.set(void 0)
            ...
            var JHc = ["#cccccc", "#333333"];
            var BJc = wc("4073adf", !1)
              , MHc = class {
                get header() {
                    if (!this.Wa.z_)
                        return new CJc(this.formData,this.Wa)
                }
                get fields() {
                    ...
                    return this.formData.fields.map(b => {
                        ...
                        case "select":
                            ...
                            case "p":
                                return new DJc(b,this.Wa);
                            case "q":
                                return new EJc(b,this.Wa);
                            case void 0:
                                switch (a) {
                                case "quiz":
                                    return new EJc(b,this.Wa);
                        ...
                        case "text":
                            switch (b.variant.type) {
                            case "f":
                                return new GJc(b,this.Wa);
                            case "e":
                                return new HJc(b,this.Wa);
                            default:
                                throw new A(b.variant);
                            }
                        case "number":
                            switch (b.variant.type) {
                            case "a":
                                return new IJc(b,this.Wa);
                            case "b":
                                return new JJc(b,this.Wa);
                            case "c":
                                return new KJc(b,this.Wa);
                            case "d":
                                return new LJc(b,this.Wa);
                            default:
                                throw new A(b.variant);
                            }
                        default:
                ...
                get aH() {
                    if ((this.fields.length !== 1 || this.fields[0].type !== 1) && this.formData.footer.ref)
                        return {
                            backgroundColor: {
                                default: this.Wa.qa.accentColor,
                                Ig: this.Wa.qa.Wlb,
                                active: this.Wa.qa.Vlb,
                                Qm: this.Wa.qa.Ylb
                            },
                ...
                get a_() {
                    const a = !!this.aH
                      , b = this.Wa.xj;
                    return {
                        Aa: b * (this.formData.footer.ref?.Gt ?? (a ? K7.footer.YHb : K7.footer.ZHb)),
                        ma: b * (this.formData.footer.ref?.Cq ?? K7.footer.Cq),
                        Ma: b * (this.formData.footer.ref?.Bq ?? K7.footer.Bq),
                        qEb: b * (this.formData.footer.ref?.Haa ?? (a ? K7.footer.Haa : 0)),
                        FJb: b * .64,
                        EJb: b * .64
                    }
                }
              ...
              , MJc = class {
                ...
                get qa() {
                    return KHc(this.yO, this.bqa, this.xSb, this.formData.header.ref?.background?.ref)
                }
                get yO() {
                    return $Gc(this.formData.gba)
                }
                get bqa() {
                    return $Gc(this.formData.Rba)
                }
                get direction() {
                    return this.formData.direction === "r" ? "r" : "l"
                }
                get Gf() {
                    return this.Fr ? this.Fr.getSettings(this.formData.iG) : {
                        status: 2
                    }
                }
                get rFb() {
                ...
                get z_() {
                    return this.formData.z_ ? !0 : (this.formData.cDa || this.formData.title.ref?.label == null) && this.formData.ara === !1
                }
                get xBa() {
                    return this.rFb === 1 && (this.formData.ara ?? !0)
                }
                get Fi() {
                    if (this.formData.Fi)
                        return this.formData.Fi;
                    const a = Tf(lg, this.zja.label.text.stream.Xg(0), "font-size");
                    return this.xBa ? a / (this.zja.IEa ?? 1.5625) : a
                }
                get xj() {
                    return this.formData.xj ?? 16
                }
                get xSb() {
                    return this.zja.aJ === "u" ? Tf(lg, this.zja.label.text.stream.Xg(0), "color") : void 0
                }
                get zja() {
              ...
              , CJc = class {
                get background() {
                    return this.formData.header?.ref?.background.ref ?? this.formData.gba
                }
                get label() {
                    var a = this.formData.fields.first();
                    return (a = this.Wa.xBa ? a.label.text : this.formData.title?.ref?.label) ? OJc(a, this.Wa.direction) : r7("", {
                        "font-size": this.Wa.Fi * 1.953,
                        direction: LHc(this.Wa.direction)
                    })
                }
                get padding() {
                    const a = this.formData.header.ref;
                    return {
                        ja: this.Wa.xj * (a?.Gaa ?? K7.header.Gaa),
                        Aa: this.Wa.xj * (a?.Gt ?? K7.header.Gt),
                        ma: this.Wa.xj * (a?.Cq ?? K7.header.Cq),
                        Ma: this.Wa.xj * (a?.Bq ?? K7.header.Bq)
                    }
                }
                constructor(a, b) {
                    this.formData = a;
              ...
              , PJc = class {
                ...
                get label() {
                    return OJc(this.Ad.label.text, this.Wa.direction)
                }
                get rdb() {
                    return !this.Wa.xBa
                }
                get accentColor() {
                    return this.Wa.qa.accentColor
                }
                get wM() {
                    return this.Wa.qa.wM
                }
                get wub() {
                    return this.Wa.Fi * .8
                }
              ...
              , QJc = class extends PJc {
                get placeholder() {
                    return {
                        color: m7(this.Wa.qa.uH, .5),
                        text: this.Ad.placeholder || ""
                    }
                }
                get W() {
                    return this.Ad.W ?? 8
                ...
                get borderColor() {
                    return {
                        default: this.Wa.qa.dya,
                        Ig: this.Wa.qa.fya,
                        focus: this.Wa.qa.eya,
                        error: this.Wa.qa.wM
                    }
                }
                get hd() {
                    return {
                        default: this.Wa.qa.uH,
                        Qm: this.Wa.qa.$fa
                    }
                }
                get sizes() {
              ...
              , GJc = class extends QJc {
                get TN() {
                    return this.Ad.variant.TN
                }
                constructor(...a) {
                    super(...a);
                    this.variant = 2
              ...
              , HJc = class extends QJc {
                constructor(...a) {
                    super(...a);
                    this.TN = this.variant = 1
                }
            }
              , L7 = class extends PJc {
                get W() {
                    return this.Ad.W ?? 8
                }
                constructor(...a) {
              ...
              , JJc = class extends L7 {
                get backgroundColor() {
                    return {
                        default: this.Wa.qa.f6,
                        Ig: this.Wa.qa.g6,
                        active: this.Wa.qa.tha,
                        selected: this.Wa.qa.uha,
                        error: this.Wa.qa.wM,
                        Qm: this.Wa.qa.EY
                    }
                }
              ...
              , SJc = class extends PJc {
                get options() {
                    return this.Ad.options.map(a => new RJc(a,this.Wa))
                }
                get Bz() {
                    return {
                        default: this.Wa.qa.f6,
                ...
                get hqa() {
                    return this.Ad.A0 !== void 0 && this.Ad.A0 !== 1 ? "m" : "s"
                }
                get W() {
                    return this.Ad.W ?? 8
                }
                get rowGap() {
                    return .512 * this.Wa.xj
                }
                get sizes() {
                    return {
                        Qc: this.Wa.Fi * 1,
              ...
              , EJc = class extends SJc {
                ...
                get Gf() {
                    return d7(this.Wa.Gf, {
                        MO: a => (a = a.$L.get(this.id) ?? []) ? {
                            status: 1,
                            data: {
                                kya: a
                            }
                ...
                constructor(...a) {
                    super(...a);
                    this.type = (EJc.G(this),
                    2)
                }
            }
              , DJc = class extends SJc {
                get cPa() {
                    return {
                        text: this.Wa.qa.F4,
                        track: this.Wa.qa.Xlb,
                        zL: this.Wa.qa.accentColor
                    }
                }
                get eOa() {
                    return {
              ...
              , RJc = class {
                ...
                get label() {
                    return OJc(this.option.label.text, this.Wa.direction)
                }
                constructor(a, b) {
                    this.option = a;
                    this.Wa = b
            ...
            var XJc;
            XJc = __c.DZ()( ({SL: {la: a, xg: b, cb: c}, hi: {jwb: d, ph: e}}) => {
                const f = C7.box()
                  , g = new WeakMap;
                return {
                    metadata: {
                    ...
                    D: __c.CZ(E7( ({data: h, Ae: k, pi: {page: l}}) => {
                        l = l.container;
                        const m = h.D.value
                          , n = m.id
                          , p = l.id;
...
//# sourceMappingURL=sourcemaps/25d6326f15bd5a5e.js.map
